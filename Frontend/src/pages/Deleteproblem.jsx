...
const Deleteproblem = () => {
  ...
  const handleDeleteClick = async (problem) => {
    const confirmDelete = window.confirm(`Are you sure you want to delete the problem "${problem.title}"? This action cannot be undone.`);
    if (!confirmDelete) return;

    const deleted = await axiosClient.delete(`/problem/delete/${problem._id}`);
