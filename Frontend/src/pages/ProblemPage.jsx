  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-gray-100 flex flex-col" style={{ fontFamily: "'JetBrains Mono', 'Fira Code', monospace" }}>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* ════ LEFT PANEL ════ */}
        <div className="w-[42%] flex flex-col border-r border-[#30363d] overflow-hidden">

          {/* Left Tabs */}
          <div className="flex border-b border-[#30363d] bg-[#161b22] shrink-0">
            {['description', 'testcases', 'solutions'].map(tab => (
              <button
                key={tab}
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="h-12 bg-[#161b22] border-b border-[#30363d] flex items-center px-4 gap-3 shrink-0">
            ...
            {/* Action Buttons */}
            <button
              onClick={() => {/* run logic here later */}}
              className="flex items-center gap-2 px-4 py-1.5 bg-[#21262d] hover:bg-[#30363d] text-gray-300 hover:text-white text-xs font-semibold rounded-lg border border-[#30363d] transition-all"
            >
              ▶ Run
            </button>
            <button
              onClick={() => {/* submit logic here later */}}
              className="flex items-center gap-2 px-4 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-bold rounded-lg transition-all shadow-lg shadow-emerald-900/40"
            >
              ↑ Submit
            </button>
          </div>
